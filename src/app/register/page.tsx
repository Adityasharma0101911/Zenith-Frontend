// material design 3 registration page with gsap animations
"use client";
                    ...
                    <div ref={innerRef} className="bg-m3-surface-container-low rounded-m3-xl p-8 shadow-m3-2">
                        <div ref={iconContainerRef} className="w-16 h-16 rounded-m3-full bg-m3-tertiary-container flex items-center justify-center mx-auto mb-5">
                            {success ? (
                                ...
                                <div><UserPlus className="text-m3-on-tertiary-container" size={28} /></div>
                            )}
                        </div>
                        <h1 ref={titleRef} className="text-m3-headline-small text-m3-on-surface text-center">Create your vault</h1>
                        <p ref={subtitleRef} className="text-m3-body-medium text-m3-on-surface-variant text-center mt-1">Set up your Zenith guardian account</p>
                        <form ref={formRef} onSubmit={handleRegister} className="flex flex-col gap-5 mt-8">
